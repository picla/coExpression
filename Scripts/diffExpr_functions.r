...
# function to create dataframe with differentially expressed genes sleected on log2FoldChange and adjusted p-value
...
volcanoplot_geneSelection <- function(genes, background, main = 'volcano plot', FC = 2, padj = 0.05)
{
  ...
  points(genes.data$log2FoldChange, -log10(genes.data$padj), pch=20, col = 'red', cex=1.0)
